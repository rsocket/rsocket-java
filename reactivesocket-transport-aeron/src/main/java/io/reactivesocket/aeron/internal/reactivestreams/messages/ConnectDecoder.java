...
package io.reactivesocket.aeron.internal.reactivestreams.messages;

import org.agrona.MutableDirectBuffer;
import org.agrona.DirectBuffer;

@javax.annotation.Generated(value = {"io.reactivesocket.aeron.internal.reactivestreams.messages.ConnectDecoder"})
...
public class ConnectDecoder
{
    ...
    public int getSendingChannel(final MutableDirectBuffer dst, final int dstOffset, final int length)
    {
    ...
    public int getReceivingChannel(final MutableDirectBuffer dst, final int dstOffset, final int length)
    {
        final int headerLength = 4;
        final int limit = parentMessage.limit();
        final int dataLength = (int)(buffer.getInt(limit, java.nio.ByteOrder.LITTLE_ENDIAN) & 0xFFFF_FFFFL);
    ...
    public int getClientManagementChannel(final MutableDirectBuffer dst, final int dstOffset, final int length)
    {
        final int headerLength = 4;
        final int limit = parentMessage.limit();
        final int dataLength = (int)(buffer.getInt(limit, java.nio.ByteOrder.LITTLE_ENDIAN) & 0xFFFF_FFFFL);
