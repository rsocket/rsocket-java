 ...
 * The time at which you insert the value into `Ewma` is used to compute a weight (recent
 * points are weighted higher).
 ...
 *      the ewma will be equal to (200 - 100)/2 = 150 (half of the distance between the
