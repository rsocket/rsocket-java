...
final class ResolvingPooledRSocket extends ResolvingOperator<RSocket>
  ...
  final RSocketSupplier rSocketSupplier;
  final Stats stats;
  ...
  ResolvingPooledRSocket(RSocketSupplier rSocketSupplier, Stats stats) {
    this.stats = stats;
  ...
  protected void doSubscribe() {
    this.rSocketSupplier.source().subscribe(this);
  }
  ...
  @Override
  public RSocketSupplier supplier() {
