...
public class RequestFrameFlyweightTest {
  ...
  public void testEncoding() {
    ...
    DefaultPayload payload =
        new DefaultPayload(Frame.from(stringToBuf("000010000000011900000000010000026d6464")));
  ...
  public void testEncodingWithEmptyMetadata() {
    ...
    DefaultPayload payload =
        new DefaultPayload(Frame.from(stringToBuf("00000e0000000119000000000100000064")));
  ...
  public void testEncodingWithNullMetadata() {
    ...
    DefaultPayload payload = new DefaultPayload(Frame.from(stringToBuf("00000b0000000118000000000164")));
