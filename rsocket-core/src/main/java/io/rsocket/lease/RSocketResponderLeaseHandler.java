...
public class RSocketResponderLeaseHandler implements ResponderLeaseHandler {
  ...
  public RSocketResponderLeaseHandler(
      String tag,
    ...
    return leaseSender
        ...
        .subscribe(
            lease -> {
              ...
              leaseStats.start(
                  lease, Math.max(10, lease.getTimeToLiveMillis() / windowsCount), windowsCount);
