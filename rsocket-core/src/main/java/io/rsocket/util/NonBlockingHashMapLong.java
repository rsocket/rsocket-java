 ...
 * io.rsocket.util.NonBlockingHashMap} with {@link Long} keys is
...
public class NonBlockingHashMapLong<TypeV>
  ...
  private class SnapshotE implements Iterator<Entry<Long,TypeV>> {
    ...
    public void remove() { _ss.remove(); }
    public Entry<Long,TypeV> next() { _ss.next(); return new SimpleImmutableEntry<>(_ss._prevK,_ss._prevV); }
    public boolean hasNext() { return _ss.hasNext(); }
  }
   ...
   *  iteration.  The {@link io.rsocket.util.NonBlockingHashMap}
