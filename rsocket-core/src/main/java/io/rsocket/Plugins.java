...
public class Plugins {
  ...
  public interface DuplexConnectionInterceptor
  ...
  public static final DuplexConnectionInterceptor NOOP_DUPLEX_CONNECTION_INTERCEPTOR =
      (type, connection) -> connection;
  private static final RSocketInterceptor NOOP_INTERCEPTOR = Mono::just;

  public static volatile DuplexConnectionInterceptor DUPLEX_CONNECTION_INTERCEPTOR =
      NOOP_DUPLEX_CONNECTION_INTERCEPTOR;
