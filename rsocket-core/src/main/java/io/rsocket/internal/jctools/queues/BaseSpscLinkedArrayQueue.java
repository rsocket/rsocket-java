...
import static io.rsocket.internal.jctools.queues.CircularArrayOffsetCalculator.calcElementOffset;
import static io.rsocket.internal.jctools.queues.LinkedArrayQueueUtil.length;
import static io.rsocket.internal.jctools.queues.LinkedArrayQueueUtil.nextArrayOffset;
...
abstract class BaseSpscLinkedArrayQueueConsumerColdFields<E>
    extends BaseSpscLinkedArrayQueuePrePad<E> {
  protected long consumerMask;
  protected E[] consumerBuffer;
}

// $gen:ordered-fields
abstract class BaseSpscLinkedArrayQueueConsumerField<E>
    extends BaseSpscLinkedArrayQueueConsumerColdFields<E> {
  private static final long C_INDEX_OFFSET =
      fieldOffset(BaseSpscLinkedArrayQueueConsumerField.class, "consumerIndex");
...
abstract class BaseSpscLinkedArrayQueueProducerFields<E> extends BaseSpscLinkedArrayQueueL2Pad<E> {
  private static final long P_INDEX_OFFSET =
      fieldOffset(BaseSpscLinkedArrayQueueProducerFields.class, "producerIndex");
...
abstract class BaseSpscLinkedArrayQueueProducerColdFields<E>
    extends BaseSpscLinkedArrayQueueProducerFields<E> {
...
abstract class BaseSpscLinkedArrayQueue<E> extends BaseSpscLinkedArrayQueueProducerColdFields<E>
  ...
  public int drain(Consumer<E> c, int limit) {
    E e;
    int i = 0;
    for (; i < limit && (e = relaxedPoll()) != null; i++) {
      c.accept(e);
    }
    return i;
  }
  ...
  abstract boolean offerColdPath(
      E[] buffer, long mask, long pIndex, long offset, E v, Supplier<? extends E> s);
